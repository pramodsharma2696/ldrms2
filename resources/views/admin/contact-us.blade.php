                        ...
                        >
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        required="true"
                                        value="{{ $contactUs ? $contactUs->PageTitle : old('pagetitle') }}"
                                    />
                                    @error('pagetitle')
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    > {{ $contactUs ? $contactUs->PageDescription : old('pagedescription') }}</textarea>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        required="true"
                                        value="{{ $contactUs ? $contactUs->Email : old('email') }}"
                                    />
                                    @error('email')
                                   <span style="color:red">{{$message}}</span>
                                   @enderror
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        required="true"
                                        value="{{ $contactUs ? $contactUs->MobileNumber : old('phonenum') }}"
                                    />
                                    @error('phonenum')
                                   <span style="color:red">{{$message}}</span>
                                   @enderror
