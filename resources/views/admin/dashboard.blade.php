...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        ...
                        align-items-center justify-content-between bg-primary">
                            <div class="s-l">
                                <h5>Total Product</h5>
                                <a class="text-muted text-uppercase m-b-20" href="{{route('products.index')}}" style="font-size: 20px">
                                    <h6 style="color: black;padding-top: 10px">View</h6>
                                </a>
                            </div>
                            <div class="s-r">
                                <h6>{{$productCount}}
                        ...
                        <div class="stat-grid p-3 mt-3 d-flex align-items-left justify-content-between bg-success">
                            <div class="s-l">
                                <h5>New Booking</h5>
                                <a class="text-muted text-uppercase m-b-20" href="{{route('get-new-bookings')}}" style="font-size: 20px">
                                    <h6 style="color: black;padding-top: 10px">View</h6>
                                </a>
                            </div>
                            <div class="s-r">
                        ...
                        <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-danger">
                            <div class="s-l">
                                ...
                                <a class="text-muted text-uppercase m-b-20" href="{{route('get-approved-bookings')}}" style="font-size: 20px">
                                    <h6 style="color: black;padding-top: 10px">View</h6>
                                </a>
                            </div>
                            <div class="s-r">
                        ...
                        <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-warning">
                            <div class="s-l">
                                ...
                                <a class="text-muted text-uppercase m-b-20" href="{{route('get-unapproved-bookings')}}" style="font-size: 20px">
                                    <h6 style="color: black;padding-top: 10px">View</h6>
                                </a>
                            </div>
                            <div class="s-r">
                        ...
                        <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-primary">
                            <div class="s-l">
                                <h5>Total Booking</h5>
                                <a class="text-muted text-uppercase m-b-20" href="{{route('get-all-bookings')}}" style="font-size: 20px">
                                    <h6 style="color: black;padding-top: 10px">View</h6>
                                </a>
                            </div>
                            <div class="s-r">
                                <h6>{{$totalBookingCount}}
                                    <i class="far fa-edit"></i>
                                </h6>
                            </div>
                        </div>
                        <div class="stat-grid p-3 mt-3 d-flex align-items-left justify-content-between bg-success">
                            <div class="s-l">
                                <h5>Total Brand</h5>
                                <a class="text-muted text-uppercase m-b-20" href="{{route('brand.index')}}" style="font-size: 20px">
                                    <h6 style="color: black;padding-top: 10px">View</h6>
                                </a>
                            </div>
                            <div class="s-r">
            ...
            </div> @include('includes.admin-footer')
        </div>
    </div>
    <!-- Required common Js -->
