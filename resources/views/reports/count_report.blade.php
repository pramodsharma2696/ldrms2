        ...
        <div id="content">
            ...
            <section class="tables-section">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Request Count Reports</h4>
                   
      
 
                    <div class="container-fluid">
                        <div class="row">
                        <form class="form-horizontal" method="post"  action="{{route('generate.count.report')}}" enctype="multipart/form-data">
                         @csrf
                       <div class="col-12">
                           <div class="card-box">
